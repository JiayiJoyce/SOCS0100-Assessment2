...
The `wrangled_IFPI_data` dataframe contains the music market value from 2011 to 2017, with 8 columns and 77 rows. It showcases the percentage of different facets of the music market (`physical`, `digital`, `performance rights`) in countries with leading market sizes and therefore have implications in the study of media [@geurts2023]in social science.
...
-   It showcased that while US and Japan has two of the larges music markets, they operate in drastically different trends. While US is rapidly digitizing during 2011-2017, Japan's market remained highly physical.
